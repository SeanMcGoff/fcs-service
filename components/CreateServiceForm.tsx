        ...
        <h2 className="text-2xl text-center mg-6"><b>Create a Service</b></h2>
            <div className="flex flex-wrap -mx-3 mb-6">
                ...
                <div className="w-full md:w-1/4 px-3 mb-6 md:mb-0">
                    <label className="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">
                        # Available*
                        <input className={inputClassName} {...register("availableStudentSlots", { required: true, min: 1, max: watch("maxStudents")})}
                        ...
                        {errors.availableStudentSlots?.type === 'min' && <span className="text-red-500">Must be at least 1</span>}
